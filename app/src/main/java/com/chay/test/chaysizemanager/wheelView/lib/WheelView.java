...
import com.chay.test.chaysizemanager.wheelView.adapter.WheelAdapter;
...
public class WheelView extends View {
    ...
    // 条目间距倍数
    static final float lineSpacingMultiplier = 2.4F;
    boolean isLoop;
    ...
    // 修改这个值可以改变滑行速度
    private static final int VELOCITYFLING = 4;
    ...
    private void initPaints() {
        ...
        paintOuterText.setTextScaleX(0.8F);
        ...
        paintCenterText.setTextScaleX(0.9F);
    ...
    private void remeasure() {
        ...
        //计算两条横线和控件中间点的Y位置
        firstLineY = (measuredHeight - itemHeight) / 2.0F - CommUtil.dp2px(context, 6);
        secondLineY = (measuredHeight + itemHeight) / 2.0F + CommUtil.dp2px(context, 6);
